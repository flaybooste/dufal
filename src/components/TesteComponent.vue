  ...
  <div class="container">
    ...
    <div class="columns">
      ...
      <div class="column">
        <div class="field mb-5">
          <label class="label">
            Total Difal R$ {{ totalDifal.toFixed(2) }}
          </label>
        </div>
      </div>
    </div>
        ...
        <ol type="1">
          ...
          >
            <div v-if="linha.Finalidade != 'Devolução'">
              ...
              <br />
              <p>
                <span v-if="linha.Finalidade != 'Devolução'"
                  >FINALIDADE: {{ linha.Finalidade }}</span
                ><br />
                  ...
                  <div class="column">
                    <a
                      ><strong
                        ...
                        {{
                          calcularDifal(
                            linha.ICMS_Base_Calculo,
                            (impICMS = linha.Valor_ICMS)
                          )[0]
                        }}</strong
                      ></a
                    >
                    ...
                    <a
                      ><strong>
                        ...
                        {{
                          calcularDifal(
                            linha.Valor_Produto,
                            (impICMS = linha.Valor_Produto * 0.12)
                          )[0]
                        }}</strong
                      ></a
                    >
